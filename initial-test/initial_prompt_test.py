...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('mp_test_ollama_queries.log'),
...
if __name__ == "__main__":
    try:
        questions = load_questions("mp_test_prompt.json")  # Update filename
        ...
        process_questions(questions, "mp_prompt_test_responses.csv")  # Update filename
